...
interface props {
	methods: UseFormReturn<{ otp: string }, any, undefined>
	handleEnterCode: (data: any) => void

}

const EnterCode = ({methods, handleEnterCode}: props) => {
	return <>
		<m.div
			...
			<div className="w-full p-4 sm:p-12.5 xl:p-17.5">
				...
				<FormProvider {...methods}>
					<form onSubmit={methods.handleSubmit(handleEnterCode)}>
						<InputAuthentication name={"otp"} type={"text"}
											 placeholder={"Enter your code"} icons={<Person/>}
											 label={"Otp"}/>
